Covariate = function(input = NULL, choice = NULL) {
  StepName = "Covariate"
  Choices = c("None","Gender_MF", "Gender", "Age_MF", "Age",
              "Contraceptives", "RelationshipStatus", "MPQ_PositiveEmotion","RST_BAS",
              "NegativeAffect", "BDI_Depression",
              "BFI_OpenMindedness","BFI_Conscientiousness","BFI_Agreeableness", "BFI_Extraversion", "BFI_Neuroticism", "Big5_OCEAN")
  Order = 4
  output = input$data
