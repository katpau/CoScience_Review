Covariate = function(input = NULL, choice = NULL) {
  ...
  NumericVariables = c("EEG_Signal", "SME", "Epochs", names(output)[grepl("Covariate_", names(output))])
  GroupingVariables = c("ID", "Condition",  "Component", "Task", names(output)[grepl("Covariate_Gender", names(output))])
  ...
  GroupingVariables = c("Condition", "Component", "Task")
