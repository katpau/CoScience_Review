...
%
% Usage:
%   >> [last_output,med1,med2,var1,var2,prior1,prior2]=EM(vec); 
%
% Input: vec (row vector, to be thresholded)
%
% Outputs: last_output (threshold value)
...
function [last_output,med1,med2,var1,var2,prior1,prior2]=EM(vec)
% renamed output "last" to "last_output" => problems compiling KP 15/07/2022
last_output = NaN;
if size(vec,2)>1
...
if isnan(last_output) % TO PREVENT CRASHES
    last_output=mediana;
end
