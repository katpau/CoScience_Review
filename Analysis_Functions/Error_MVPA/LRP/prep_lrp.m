...
for part = 1:length(participant_codes)
    ...
    EEG_data.Data.data.EEG.data_lrp_aver = zeros(length(EEG_data.Data.data.EEG.data_lrp(:,1)),1);
    for i = 1:length(EEG_data.Data.data.EEG.data_lrp(:,1))
        EEG_data.Data.data.EEG.data_lrp_aver(i) = mean(EEG_data.Data.data.EEG.data_lrp(i,:));
    end
