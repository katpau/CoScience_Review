%% This scripts compares the lrp and mvpa onsets
...
ANALYSE_DECODING_ERP('coscience',0,'all',1)
...
%load mvpa data
if strcmp(AnalysisName, "Flanker_MVPA")
      input_dir_mvpa = [bdir '\Analysis_Functions\Error_MVPA\MVPA\02_MVPA\DECODING_RESULTS\level_2\flanker\'];   
 elseif strcmp(AnalysisName, "GoNoGo_MVPA") 
    input_dir_mvpa = [bdir '\Analysis_Functions\Error_MVPA\MVPA\02_MVPA\DECODING_RESULTS\level_2\go_nogo\'];  
end
