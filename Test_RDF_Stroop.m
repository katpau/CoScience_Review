...
ImportedTask = "Stroop"; % name of Task that should be analysed, used to import right files and structure outputs
MatlabAnalysisName = "Stroop_Alpha"; % is used in the step functions for specific choices. Usually the same as Analysis Name unless multiple Tasks are included in the Analysis
