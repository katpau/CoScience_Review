...
choice = "AVBIS"     #"AVBIS","RSTPQ_BIS","BISBAS_BIS","BFI_Anxiety","PSWQ_Concerns","Z_AV_notweighted" "Z_AV_ItemNr"      "Z_AV_Reliability" "PCA"   "FactorAnalysis"
input = do.call(Personality_Variable, list(input, choice)) 

choice = "None" # "None","Age_MF","Age","AGG_Anger","BDI_Depression"    ,    "BFI_Extraversion"         "BFI_OpenMindedness"       "BFI_Conscientiousness"    "BFI_Agreeableness"        "BFI_NegativeEmotionality" "Big5_OCEAN"  
...
choice = "Applied" # "Applied" "None"
input = do.call(Outliers_AcceptanceRate, list(input, choice))  
