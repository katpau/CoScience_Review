...
choice = "BDI_Depression" # "BDI_Depression"    WHO5_Depression"    "Z_sum_Depression"  "Z_AV_notweighted_Depression" "Z_AV_ItemNr_Depression"     "Z_AV_Reliability_Depression"
input = do.call(Depression, list(input, choice)) 

   
choice = "PCA" # "PCA","RSTPQ_RewardInterest","MPQPE_PositiveEmotionality","BISBAS_BAS","Z_sum_RewardSensitivity","Z_AV_notweighted_RewardSensitivity",
# "Z_AV_ItemNr_RewardSensitivity"      "Z_AV_Reliability_RewardSensitivity"  "FactorAnalysis"
input = do.call(RewardSensitivity, list(input, choice)) 


choice = "None" # "None","Age_MF","Age","AGG_Anger","BFI_Anxiety"             
# "Anxiety_Age_Gender_State" "BFI_OpenMindedness"       "BFI_Conscientiousness"    "BFI_Agreeableness"        "BFI_Extraversion"         "Big5_OCEA"   
