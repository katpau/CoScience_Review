...
INPUT = ECG_Baseline(INPUT, "-500 0"); %  "-500 0"    "firstTP"
INPUT = ECG_Artefact(INPUT, "remove"); %  "remove"    "interpolate"
INPUT = ECG_TimeWindow(INPUT, "no_cluster"); % "2000,5000"    "3500,4000"    "Relative_Group"
