...
choice = "BISBAS_BIS"     #"BISBAS_BIS"   "PSWQ_Concerns"    "RSTPQ_BIS"        "BFI_Anxiety"      "Z_AV_notweighted" "Z_AV_ItemNr"      "Z_AV_Reliability" "PCA"              "FactorAnalysis"  
input = do.call(Personality_Variable, list(input, choice)) 

choice = "None" # "None","Age_MF","Age","AGG_Anger","BDI_Depression"    ,    "BFI_Extraversion"     "BFI_OpenMindedness"    "BFI_Conscientiousness" "BFI_Agreeableness"     "Big5_OCEA"            
