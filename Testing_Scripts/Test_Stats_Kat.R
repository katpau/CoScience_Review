...
collumnNamesEEGData=c("ID", "Condition", "Hemisphere", "Electrode", "Localisation", "FrequencyBand", "FrequencyRange", "EEG_Signal", "SME", "Epochs", "Lab", "Experimenter")
...
choice = "None" # "None"                     "Gender_MF"                "Gender"                   "Age_MF"                   "Age"       "AGG_Anger"                "WHO5_Depression"          "BFI_OpenMindedness"       "BFI_Conscientiousness"    "BFI_Agreeableness"        "BFI_NegativeEmotionality" "Big5_OCAN"   
...
choice = "pleasant_arousal_perSub" #  "pleasant_arousal_perSub" "pleasant_perSub"         "pleasant_arousal_av"    
input = do.call(BehavCovariate, list(input, choice)) 
...
input = do.call(Normalize, list(input, "Rankit")) 
