...
choice = "RSTPQ_BIS" #"RSTPQ_BIS"        "BISBAS_BIS"       "BFI_Anxiety"      "PSWQ_Concerns"    "Z_AV_notweighted" "Z_AV_ItemNr"      "Z_AV_Reliability" "PCA" "FactorAnalysis"  
...
choice = "AV" #"AV" "Anxiety"
input = do.call(StateAnxiety, list(input, choice)) 
