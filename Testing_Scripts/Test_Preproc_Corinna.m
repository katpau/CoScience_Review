...
File_to_Import = strcat(SubjectName, "\eeg\", SubjectName, "_task-Flanker_eeg.set");
...
INPUT = Baseline(INPUT, "-200 -100"); %  "-200 -100", "-300 -100"
INPUT = Trials_Performance(INPUT, "RTs_accuracy"); %  "RTs_accuracy", "accuracy"
INPUT = Trials_MinNumber(INPUT, "20"); %  "20", "32"
