...
INPUT = Trials_MinNumber(INPUT, "18"); %  "18"    "9"
...
%Relative Group not working on single subject here, is done at a different timepoint
INPUT = TimeWindow(INPUT, "200,400"); %  "Relative_Group_wide"    "Relative_Group_na…"    "Relative_Subject"    "200,400"    "250,350"
INPUT = Quantification_ERP(INPUT, "Mean"); %  "250,500"    "200,400"    "300,350"    "Relative_Group"
